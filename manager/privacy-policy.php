...
$sqlpage = mysqli_query($con, "SELECT * FROM `pages` WHERE slug = 'privacy-policy'");
...
if(isset($_POST['editRecord'])){
	...
	$sqlcheck = mysqli_query($con,"UPDATE `pages` SET `title` = '$ptitle', `subtitle` = '$psubtitle', `description` = '$pdesc' WHERE slug = 'privacy-policy'");
