...
if(isset($_POST['addTc'])){
	...
	if(isset($_FILES['img']['name'])){
		$uploadpath = createImgWebp("img", "associations");
	}

	$sqlins = mysqli_query($con,"INSERT INTO associations (`id`, `file`, `order`, `status`) VALUES (NULL, '$uploadpath', '$order', 1)");
		
	if($sqlins){
		echo "<script>swal('Added Successfully', 'Click `OK` to Close', 'success'); 
				$('#submitForm').hide();
			 </script>";
		echo "<div class='col-md-12 padd0 text-center'><a href='createassociation.php' class=' btn btn-primary'>Create New</a></div>";
	}else{	
...
<div class="col-md-12">
	<div class="page-title">
		...
		<div class="createbtn">
			<a href="associations.php"> List</a>
		</div>
	</div>
</div>
