...
$sqltc = mysqli_query($con, "SELECT * FROM services WHERE id = {$tcupid}");
...
if(isset($_POST['updateinfo'])){
	...
	$sqlcheck = mysqli_query($con,"UPDATE services SET title = '$title',  url = '$url', `desc` = '$desc', `sdesc` = '$sdesc', file = '$uploadpath', `order` = '$order' WHERE id = $tcupid");
