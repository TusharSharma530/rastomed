...
// ===== section heading: mission se, warna vision =====
$mvHeading = '';
if ($missionRow && trim($missionRow['c_name']) !== '') {
	$mvHeading = trim($missionRow['sdesc']) !== '' ? $missionRow['sdesc'] : $missionRow['c_name'];
} elseif ($visionRow && trim($visionRow['c_name']) !== '') {
      ...
      <div class="container">
        <div class="grid-2-col">
          <div class="reveal reveal--left">
            ...
            <p class="about-p-desc"><?= htmlspecialchars($para, ENT_QUOTES, 'UTF-8') ?></p>
            <?php endforeach; ?>
